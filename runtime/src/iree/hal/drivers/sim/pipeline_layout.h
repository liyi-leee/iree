...
#ifndef IREE_AMD_AIE_DRIVER_SIM_PIPELINE_LAYOUT_H_
#define IREE_AMD_AIE_DRIVER_SIM_PIPELINE_LAYOUT_H_
...
// The max number of bindings per descriptor set allowed in the SIM HAL
// implementation.
#define IREE_HAL_SIM_MAX_DESCRIPTOR_SET_BINDING_COUNT 16

// The max number of descriptor sets allowed in the SIM HAL implementation.
//
// This depends on the general descriptor set planning in IREE and should adjust
// with it.
#define IREE_HAL_SIM_MAX_DESCRIPTOR_SET_COUNT 4
...
//
// In SIM, however, we don't have a direct correspondance of such mechanism.
// Resources are expressed as kernel arguments. Therefore to implement IREE
// HAL descriptor set and pipepline layout in SIM, we order and flatten all
...
#endif  // IREE_AMD_AIE_DRIVER_SIM_PIPELINE_LAYOUT_H_
