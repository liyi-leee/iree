...
#ifndef IREE_AMD_AIE_DRIVER_SIM_NATIVE_EXECUTABLE_H_
#define IREE_AMD_AIE_DRIVER_SIM_NATIVE_EXECUTABLE_H_
...
typedef struct iree_hal_sim_kernel_params_t {
...
#endif  // IREE_AMD_AIE_DRIVER_SIM_NATIVE_EXECUTABLE_H_
